        ...
        if self.pk is not None:
            ...
            if orig.is_approved != self.is_approved:
                ...
                if self.is_approved == True:
                    ...
                    mail_subject = "Congratulations! Your submission has been approved."
                    send_notification(mail_subject, mail_template, context)
                else:
                    # Send notification email
                    mail_subject = "We're sorry! You are not eligible for publishing your product catalog on our marketplace."
                    send_notification(mail_subject, mail_template, context)
